...
public class Movement : MonoBehaviour
{
    ...
    void Start()
    {
        // Essas duas linhas s�o momentanias, elas servem para travar o cursor
    ...
    void FixedUpdate()
    {
        ...
        // Converte o movimento para ser relativo � rota��o do jogador
        Vector3 relativeMove = transform.TransformDirection(mover);

        //Aplica o movimento usando a posi��o atual + o deslocamento relativo
